...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'cheua.air.now.cc';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiOGY2ZmZiODM1MzVmYmQ2Yjg5M2Y5ODY3NjJmZjQwMjQiLCJ0IjoiOWQ5NzNjOGMtOWY1Ni00M2I5LWI0MTQtZmRkOGI0N2EwMDhlIiwicyI6IllUWmlaalF4T0RJdE1qZGpOeTAwTjJNekxUa3dZbUl0TUdWbU1HWmxPV1JtTWpneCJ9';

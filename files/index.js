...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'cheub.air.now.cc';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiOGY2ZmZiODM1MzVmYmQ2Yjg5M2Y5ODY3NjJmZjQwMjQiLCJ0IjoiMjNmYjc5ZGYtNDdhZC00Y2Y2LWEwM2EtNWRiOWNiNmM5ZjkyIiwicyI6IlpXTmtPRE15WkdRdE5XWXpZUzAwTmpNNExUa3hObVl0WkdFek9EZ3hOVFk0TmpNNSJ9';
